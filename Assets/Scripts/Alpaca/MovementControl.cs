...
public class MovementControl : MonoBehaviour {
    ...
    private NeckRotator neckRotator;
    ...
    void Awake() {
        ...
        neckRotator = gameObject.GetComponentInChildren<NeckRotator>();
    }


    void Update() {
        // The player is grounded if a linecast to the groundcheck position hits anything on the ground layer.
        grounded = Physics2D.Linecast(transform.position, groundCheck.position, ((1 << LayerMask.NameToLayer("Props")) + (1 << LayerMask.NameToLayer("Environment")) + (1 << LayerMask.NameToLayer("Boundaries")) + (1 << LayerMask.NameToLayer("Access"))));
